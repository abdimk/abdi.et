    ...
    <section className="w-full text-center py-19 px-4 bg-card-bg/50 border border-border-color shadow-[4px_4px_0_var(--color-shadow-color)] transition-colors duration-300">
      ...
      <div className="flex flex-col sm:flex-row justify-center gap-4 flex-wrap">
        <a
          ...
          className="inline-block py-3 px-6 text-base font-bold border-2 border-text-color no-underline text-btn-primary-text bg-btn-primary-bg rounded-lg transition-colors duration-200 w-full sm:w-auto text-center hover:opacity-90"
          download
        >
          📄 Download Resume
        </a>
